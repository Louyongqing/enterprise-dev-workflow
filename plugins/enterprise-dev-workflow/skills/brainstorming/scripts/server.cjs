...
const CONTENT_DIR = process.env.BRAINSTORM_CONTENT_DIR || path.join(SESSION_DIR, 'content');
...
function brandMarkup() {
  ...
  // Text attribution avoids an automatic third-party network request. The
  // upstream link is contacted only if the user chooses to open it.
