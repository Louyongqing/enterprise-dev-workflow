...
#
# Kills the server process and removes sensitive runtime files. The operating
# system cleans the remaining private temp directory; this script never performs
# a recursive deletion on a caller-supplied path.
